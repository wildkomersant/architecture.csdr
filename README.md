...
Интерфейс же я хотел видеть как трансформер, где html вполне управляем и подвижен.

![](/Картинки/Игрушка.jpg)

В итоге должен состояться исконный подход к программированию, сопровождающий построение проекта (ядра, интерфейса, сайта), и не дозволяющий неприемлемое. 
...
По моим расчётам (и подсказкам таки еврейских братьев) наш мир 4-х-мерный: прошлое (наша опора), будущее (наша среда), объединяющее (таки да, торговля и подарки важны) и настоящее (наши дела). Основавшись на таких знаниях, и признав, что лучшего целостного программирования, согласованного с ходом нашего времени, для моих устремлений не найти, я утвердил, что разрабатываемый проект (ядро, интерфейс, сайт) нуждается во вложении в себя 4-х потенцилов: 

1. Прав
2. Ролей
3. Возможностей и приобретений
4. Способностей
...
Для принятия потенциалов я спроектировал такие компоненты: Conditions, Space, Distribution и Realization. Зафиксируем их как международную аббревиатуру CSDR. 
...
![](/Картинки/Общение.png) <a target="_blank" href="https://habr.com/ru/post/475976/">На habr.com</a><br>
